...
const ALL_AIRPORTS: Airport[] = [
  ...
  { code: 'LIN', name: 'Milan Linate Airport', city: 'Milan', country: 'Italy', flag: '🇮🇹' },
  { code: 'FCO', name: 'Rome Fiumicino Airport', city: 'Rome', country: 'Italy', flag: '🇮🇹' },
  { code: 'MAD', name: 'Adolfo Suárez Madrid-Barajas', city: 'Madrid', country: 'Spain', flag: '🇪🇸' },
  { code: 'BCN', name: 'Barcelona El Prat Airport', city: 'Barcelona', country: 'Spain', flag: '🇪🇸' },
